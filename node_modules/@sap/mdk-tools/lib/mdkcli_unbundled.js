...
async function cli() {
    ...
    yargs.
        ...
        command("migrate [--project]", "Migrate project to the latest schema version", {}, async (argv) => {
        ...
        // command("migrate-script [--project]", "Migrate project to the latest schema version for the script files", {}, async (argv) => {
        //     const scirptMigrator = require("../lib/migrator/migrate-script-cli.js");
        //     scirptMigrator.checkScriptFiles()
        //         .catch((err) => {
        //             console.error(logger.getError(err));
        //             process.exit(-1);
        //         });
        ...
        */
        ...
        command("validate-mergemap [--baseProject] [--extProject]", "Validate mergemap files in project", {}, async (argv) => {
