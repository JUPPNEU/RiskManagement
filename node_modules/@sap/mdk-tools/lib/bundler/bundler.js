      ...
      aComponents.forEach((oComponent) => {
        ...
        oComponent.IntegrationPoints.forEach(integrationPoint => {
          ...
          if (aSourceSegements[1] === sApplicationName && aTargetSegements[1] === oComponent.ApplicationName) {
            ...
            instance._linkComponent(oComponent.__path__, path.join(sApplicationPath, aTargetSegements.join(path.sep)), path.join(instance.componentSourcePath(oComponent), aSourceSegements.join(path.sep)), integrationPoint);
          }
        });
      });
      return aComponents;
