          ...
          optionList: [
            {
              name: 'target',
              typeLabel: '',
              description: 'Type of the build result, it can be js, zip, module or mta'
            },
            {
              name: 'project',
            ...
            },
            {
              name: 'forceUpdate',
              typeLabel: '',
              description: 'if force update template'
            },
            {
              name: 'ui5',
              typeLabel: '',
              description: 'if use ui5 wrapper'
            },
            {
              name: 'externals',
            ...
            },
            {
              name: 'recursive',
              typeLabel: '',
              description: 'if find projects recursive'
            },
            {
              name: 'wmf',
            ...
            {
              name: 'log',
              description: 'output details for log'
            },
            {
              name: 'devtool',
            ...
            {
              name: 'validate',
              description: 'If this option is specified, it will validate metadata before build.'
            },
            {
              name: 'file',
              description: 'If this option is specified, it will generate extension points report.'
            },
            {
              name: 'content',
            ...
            {
              name: 'fromProject',
              description: 'the compare project when build migrate report'
            }
          ]
        }
      ]
